...
namespace ReBase
{
    public class UnconfiguredClientException : Exception
    {
        public string Patterns { get; }
        public UnconfiguredClientException() { }

        public UnconfiguredClientException(string message)
            : base(message) { }

        public UnconfiguredClientException(string message, Exception inner)
            : base(message, inner) { }
    }
}